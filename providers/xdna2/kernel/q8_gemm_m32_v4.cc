...
//
// Compensated Q8_0 GEMM for a 32x128 activation tile and a 128x64
// weight tile. Both matrices and the FP32 result use AIE mmul block order.
// The 2x2 accumulator expansion follows AMD IRON's optimized AIE2P GEMM
// (aie_kernels/aie2p/mm.cc, release/main as inspected 2026-08-17).
...
constexpr unsigned kAElements = kM * kK;
...
void zero_q8_v4_f32_m32(float * output) {
...
void gemm_q8_v4_f32_m32(const bfloat16 * __restrict input,
