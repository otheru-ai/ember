...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_Q4_0_ROCMI4       = 108, // signed int4 nibbles + UE4M3 scale
        GGML_TYPE_COUNT   = 109,
    };
    ...
    enum ggml_ftype {
        ...
        // 118 is ROCmFPX's canonical ROCMI4 file type. Older Ember Q2 files
        // used 118 as recipe metadata; their tensor type 107 remains unchanged
        // and loaders dispatch by tensor type, so those GGUFs remain readable.
        GGML_FTYPE_MOSTLY_Q4_0_ROCMI4           = 118,
        GGML_FTYPE_MOSTLY_Q2_0_ROCMFP2          = 119,
