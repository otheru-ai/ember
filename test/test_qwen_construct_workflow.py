...
class QwenConstructWorkflowTest(unittest.TestCase):
    ...
    def test_matched_quant_comparison_lane_is_nonpublishing_and_bounded(self) -> None:
        ...
        self.assertIn("Surface retained IU4 benchmark diagnostics", body)
        self.assertIn("differential-decode-comparison.json", body)
        self.assertIn("same-process AR / warm MTP", body)
        self.assertIn("IU4−Q3 decode median / AR / warm-MTP deltas", body)
