...
typedef struct {
    ...
    // Request-omission sampler defaults. Keep this surface aligned with the
    // sidecar schema and the backend sampler; otherwise a parsed card value can
    // be silently discarded between startup and generation.
